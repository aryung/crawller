...
async function main() {
  ...
  try {
    ...
    console.log('❌ 無法讀取配置目錄:', activeDir);
    process.exit(1);
  }
  
  if (configFiles.length === 0) {
    console.log('❌ 沒有找到 Yahoo Finance TW dividend 配置文件');
    console.log('💡 請先執行: node scripts/generate-yahoo-tw-configs.js');
    process.exit(1);
  }
  ...
  console.log('🔍 Yahoo Finance Taiwan Dividend 批量爬蟲');
  console.log('===============================================');
