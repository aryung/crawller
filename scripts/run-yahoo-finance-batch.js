...
async function main() {
  console.log('🎯 Yahoo Finance Japan 批處理爬蟲');
  console.log('=====================================');
  
  // 尋找所有 Yahoo Finance 配置文件
  ...
  if (configFiles.length === 0) {
    console.log('❌ 沒有找到 Yahoo Finance 配置文件');
    console.log('💡 請先執行: node scripts/generate-batch-configs.js');
    process.exit(1);
  }
  ...
  console.log('\n📁 輸出文件位置: output/');
  console.log('💡 可使用 ls output/ 查看所有生成的文件');
}
